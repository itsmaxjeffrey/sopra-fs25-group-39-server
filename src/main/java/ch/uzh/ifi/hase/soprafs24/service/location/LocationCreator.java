...
import ch.uzh.ifi.hase.soprafs24.rest.mapper.CarDTOMapperImpl;
...
public class LocationCreator {
    ...
    private final CarDTOMapperImpl carDTOMapperImpl;
    
    private final LocationRepository locationRepository;
    private final LocationDTOMapper locationDTOMapper;
    private final LocationValidator locationValidator;
    
    public LocationCreator(LocationRepository locationRepository, LocationDTOMapper locationDTOMapper, LocationValidator locationValidator, CarDTOMapperImpl carDTOMapperImpl) {
        this.locationRepository = locationRepository;
        this.locationDTOMapper = locationDTOMapper;
        this.locationValidator = locationValidator;
        this.carDTOMapperImpl = carDTOMapperImpl;
    }
