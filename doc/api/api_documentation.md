...
| No ❌ | No ❌ | `/api/v1/map/contracts` | GET | `lat <number>`, `lng <number>`, `radius <number>`, `filters <object>` | Query | 200 | GeoJSON of proposals | Get proposals for map display | S11, S17 |
